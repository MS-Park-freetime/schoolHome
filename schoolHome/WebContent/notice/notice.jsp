...
<header class="all">
	...
	<center>
		...
		<table width="700">
			<tr>
				<td align="right"><a
					href="noticeWriteForm.jsp">글쓰기</a></td>
		</table>
...
%>
			<tr height="30">
				...
				<td width="250">
		 <a	href="../notice/noticeContent.jsp?num=<%=notice.getNum()%>&pageNum=<%=currentPage%>">
						<%=notice.getSubject()%></a> <% if(notice.getReadcount()>=30){%> <img
					src="../images/hot.gif" border="0" height="16">
					<%}%>
				</td>
				<td align="center" width="100"><%=notice.getUserID()%></td>
				<td align="center" width="150"><%=notice.getReg_date()%></td> 
