...
<tr height="30">
  ...
  <tr>
    ...
    <td align="left" width="625" colspan="3"><pre><%=article.getContent()%></pre></td>
  </tr>
  <tr height="30">      
	...
	%>
	  <input type="button" value="글수정" 
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;
	  <a href="deletePro.jsp?num=<%=article.getNum()%>&pageNum=<%=pageNum%>"><input type="button" value="글삭제" onClick="return confirm('정말로 삭제하시겠습니까?')"></a>
	   &nbsp;&nbsp;&nbsp;&nbsp;
	<% 		
		}
	%>
