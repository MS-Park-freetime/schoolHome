		...
		<table width="700">
			<tr>
				<td align="right" bgcolor="<%=value_c%>"><a
					href="../board/writeForm.jsp">글쓰기</a></td>
		</table>
...
%>
	...
	%> <img src="../images/level.gif" width="<%=wid%>" height="16"> <img
					...
					href="../board/content.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>">
						<%=article.getSubject()%></a> <% if(article.getReadcount()>=30){%> <img
					src="../images/hot.gif" border="0" height="16">
					<%}%>
				</td>
				<td align="center" width="100"><%=article.getUserID()%></td>
